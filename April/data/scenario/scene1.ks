...
;このゲームで登場するキャラクターを宣言
;amatuka
[chara_new  name="amatuka" storage="chara/akane/normal.png" jname="あまつか"  ]
;キャラクターの表情登録
[chara_face name="amatuka" face="angry" storage="chara/akane/angry.png"]
[chara_face name="amatuka" face="doki" storage="chara/akane/doki.png"]
[chara_face name="amatuka" face="happy" storage="chara/akane/happy.png"]
[chara_face name="amatuka" face="sad" storage="chara/akane/sad.png"]
